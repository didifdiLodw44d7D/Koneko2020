...
namespace Koneko2020Client
{
    ...
    class Json
    {
        public List<Pair> pair = new List<Pair>();
        ...
        public string ReshapeValue(StringBuilder value, string pattern)
        {
        ...
        public void GetKeyValue(string str, out StringBuilder value, out StringBuilder key)
        {
            int len = str.Length;
            int i = 0;
            int status = 0;
            ...
            while (i < len)
            {
                ...
                if (3 == status)
                {
                    ...
                    //Console.WriteLine("value = " + valueCopy);
                }
        ...
        public void ParseJson(string str, out StringBuilder element)
        {
            int len = str.Length;
            int status = 0;
            ...
            while (i < len)
            {
                elementCopy = new StringBuilder(1024);
